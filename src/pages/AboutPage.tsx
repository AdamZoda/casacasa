  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      <section className="relative h-[88vh] min-h-[620px] w-full overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-b from-transparent via-[#050505]/80 to-[#050505]" />
      ...
      <main className="relative z-10 mx-auto max-w-[1550px] px-6 py-20 md:px-10 lg:px-16">
        ...
        <section className="grid grid-cols-1 gap-8 xl:grid-cols-12">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {about.visibility.showStory && (
                <motion.article
                  ...
                  className="group relative min-h-[360px] overflow-hidden rounded-3xl border border-white/10 bg-white/[0.035] p-8 md:p-10"
                >
                  ...
                  <p className="relative mb-10 text-xs uppercase tracking-[0.35em] text-white/35">01</p>
                  <p className="relative mb-4 text-[10px] font-bold uppercase tracking-[0.32em] text-brand-gold">Notre histoire</p>
                  <h2 className="relative mb-5 font-serif text-3xl leading-tight md:text-4xl">Une obsession du detail</h2>
                  <p className="relative text-sm leading-loose text-white/70 md:text-base">{about.story}</p>
                </motion.article>
              )}
              ...
              {about.visibility.showMission && (
                ...
                >
                  ...
                  <p className="relative mb-10 text-xs uppercase tracking-[0.35em] text-white/35">02</p>
                  <p className="relative mb-4 text-[10px] font-bold uppercase tracking-[0.32em] text-brand-gold">Notre mission</p>
                  <h2 className="relative mb-5 font-serif text-3xl leading-tight md:text-4xl">Transformer l'ordinaire en rare</h2>
                  <p className="relative text-sm leading-loose text-white/70 md:text-base">{about.mission}</p>
                </motion.article>
              )}
            </div>

            {about.visibility.showSocials && socialLinks.length > 0 && (
              <section className="rounded-3xl border border-white/10 bg-white/[0.025] p-6 md:p-8 lg:p-10">
                <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                  <div>
                    <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.35em] text-brand-gold">Presence</p>
                    <h3 className="font-serif text-3xl md:text-4xl">Réseaux officiels</h3>
                  </div>
                  <p className="max-w-xs text-xs uppercase tracking-[0.25em] text-white/35">Follow & connect</p>
                </div>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {socialLinks.map((item) => (
                    <motion.a
                      ...
                      rel="noreferrer"
                      whileHover={{ y: -4 }}
                      className="group relative overflow-hidden rounded-2xl border border-white/10 bg-black/30 px-5 py-5 transition-colors hover:border-brand-gold/60"
                    >
          ...
          <aside className="space-y-6 xl:col-span-4">
            ...
            >
              <img src={heroImage} alt="Casa Privilege" className="h-[520px] w-full object-cover transition-transform duration-1000 group-hover:scale-110" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/15 to-transparent" />
              <div className="absolute inset-x-0 bottom-0 p-8">
                <p className="mb-3 text-[10px] uppercase tracking-[0.32em] text-brand-gold">Signature</p>
                <h3 className="font-serif text-3xl">Casa Privilege</h3>
              </div>
            </motion.div>
            ...
            {about.visibility.showContactCard && (
              <motion.section
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="rounded-3xl border border-white/10 bg-white/[0.035] p-7 md:p-8"
              >
                <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.35em] text-brand-gold">Acces prive</p>
                <h3 className="mb-6 font-serif text-3xl">Contact direct</h3>
